...
from winterdrp.processors.autoastrometry.sources import BaseSource, compare_mag
from winterdrp.processors.autoastrometry.utils import dec_str_2_deg, ra_str_2_deg
