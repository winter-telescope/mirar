"""
Module containing NEOWISE-specific paths
"""

import os

NEOWISE_PIXEL_SCALE = 1.0  # arcsec/pixel

PIPELINE_NAME = "neowise"

neowise_dir = os.path.dirname(__file__)

astromatic_config_dir = os.path.join(neowise_dir, "files")
