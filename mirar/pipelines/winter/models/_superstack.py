...
class SuperStacksTable(WinterBase):  # pylint: disable=too-few-public-methods
    """
    ...
    superdiff = relationship("SuperDiffsTable", back_populates="superstack_id")
